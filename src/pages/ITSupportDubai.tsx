...
const ITSupportDubai = () => {
  const features = [
    { icon: Clock, title: "24/7 Support", description: "Round-the-clock IT assistance for your Dubai business" },
    { icon: Shield, title: "Enterprise Security", description: "Advanced cybersecurity solutions tailored for UAE businesses" },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-8">
                Comprehensive IT support services for businesses in Dubai. From managed services to cybersecurity, 
                we provide enterprise-grade solutions to keep your operations running smoothly.
              </p>
            ...
            <div className="flex justify-center">
              <img src={techCamelMascot} alt="IT Support Dubai" className="w-80 h-80 object-contain float-3d" />
            </div>
          </div>
        </div>
      </section>
