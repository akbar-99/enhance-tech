        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-12">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              IT Support In <span className="neon-text">Qatar</span>
            </h1>
            <p className="text-muted-foreground text-lg">
              Premium IT Support Services for businesses in Qatar. From Doha to across the nation, 
              we deliver enterprise-grade IT solutions to help your business thrive.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-muted-foreground text-lg leading-relaxed">
              Leading providers of <Link to="/" className="text-primary hover:underline">IT Support in Qatar</Link>. 
              We serve businesses across Doha and throughout Qatar with comprehensive IT solutions. Our team 
              understands the unique technology needs of Qatar's dynamic business environment. As certified 
              partners of leading technology vendors, we deliver world-class solutions to organizations of all sizes.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="glass-card-3d rounded-2xl p-12 text-center max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Qatar's Premier IT Support Partner</h2>
