...
const ITSupportAbuDhabi = () => {
  ...
  const services = [
    { icon: Monitor, title: "Managed IT Services", description: "Enterprise Managed IT Services in Abu Dhabi. Proactive monitoring and 24/7 support.", link: "/services#managed-it" },
    { icon: Shield, title: "Information Security Solutions", description: "Protect your Abu Dhabi business with enterprise-grade security solutions.", link: "/services#security-assessment" },
    { icon: Server, title: "Server and Storage Solutions", description: "Scalable server and storage systems for Abu Dhabi's growing businesses.", link: "/services#data-protection" },
    { icon: Network, title: "Network Solutions", description: "Advanced network solutions for secure connectivity in the capital.", link: "/services#network-infrastructure" },
    { icon: Code, title: "Software Solutions", description: "Custom software solutions for Abu Dhabi enterprises.", link: "/services#web-development" },
    { icon: Cloud, title: "Cloud Services", description: "Government-compliant cloud services for Abu Dhabi organizations.", link: "/services#cloud-migration" },
    { icon: Headphones, title: "Unified Communications", description: "Modern unified communications for Abu Dhabi businesses.", link: "/services#voip" },
    { icon: ShoppingCart, title: "Procurement Services", description: "IT procurement and vendor management for Abu Dhabi.", link: "/services#it-procurement" },
  ];
  ...
  const testimonials = [
    { name: "Sultan Al Nahyan", role: "CTO, Abu Dhabi Holdings", rating: 5, text: "Outstanding IT support services. They understand the unique needs of Abu Dhabi businesses." },
    { name: "Layla Mohammed", role: "Operations Director, Capital Enterprises", rating: 5, text: "Professional, responsive, and extremely knowledgeable. Highly recommend their services." },
    { name: "Rashid Al Ketbi", role: "IT Head, Government Services", rating: 5, text: "Compliant, secure, and reliable IT solutions. Perfect for our requirements." },
  ];
