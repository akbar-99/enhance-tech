...
const ITSupportAbuDhabi = () => {
  const features = [
    { icon: Clock, title: "24/7 Support", description: "Round-the-clock IT assistance for your Abu Dhabi business" },
    { icon: Shield, title: "Enterprise Security", description: "Advanced cybersecurity solutions for capital businesses" },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-8">
                Enterprise IT support services for businesses in Abu Dhabi. We provide comprehensive managed services, 
                cloud solutions, and cybersecurity to power your digital transformation.
              </p>
            ...
            <div className="flex justify-center">
              <img src={techCamelMascot} alt="IT Support Abu Dhabi" className="w-80 h-80 object-contain float-3d" />
            </div>
          </div>
        </div>
      </section>
