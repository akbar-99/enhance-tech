  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-12 relative overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full blur-3xl opacity-20" style={{ background: 'radial-gradient(circle, hsl(300 100% 65% / 0.3) 0%, transparent 70%)' }} />
            ...
            <div className="space-y-8">
              ...
              <div className="glass-card p-8 text-center">
                <img 
                  ...
                  className="w-48 h-48 object-contain mx-auto mb-4 animate-float"
                />
