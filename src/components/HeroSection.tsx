    ...
    <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1/2 h-full pointer-events-none overflow-hidden">
        <div className="relative w-full h-full">
          ...
          <div 
            className="absolute top-1/3 right-1/4 w-96 h-96 rounded-full blur-3xl opacity-30"
            style={{ background: 'radial-gradient(circle, hsl(200 100% 50%) 0%, transparent 70%)' }}
          />
          <div 
            className="absolute bottom-1/4 right-1/3 w-64 h-64 rounded-full blur-3xl opacity-20"
            style={{ background: 'radial-gradient(circle, hsl(350 100% 60%) 0%, transparent 70%)' }}
          />
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-4 max-w-sm">
            ...
            <Link 
              to="/services"
              className="block w-full text-left px-5 py-4 text-forcepoint-link font-barlow text-sm font-medium hover:text-foreground transition-colors"
            >
              View All Use Cases
            </Link>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <Link 
                to="/contact" 
                className="inline-flex items-center gap-2 px-8 py-4 bg-forcepoint-cta hover:bg-forcepoint-cta-hover text-forcepoint-cta-text font-barlow font-semibold rounded-full transition-all duration-300 hover:shadow-lg"
              >
                Get Started
              ...
              <Link 
                to="/services"
                className="inline-flex items-center gap-2 text-foreground font-barlow font-medium hover:text-primary transition-colors"
              >
                Learn More
