      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-16 fade-up">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link 
              to="/contact" 
              className="btn-primary flex items-center gap-2 text-primary-foreground animated-border"
            >
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-end max-w-6xl mx-auto stagger-children">
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative float-3d">
              <img 
                ...
                src="/lovable-uploads/f2d5b9d6-9157-4702-aaad-3d50cd206edb.jpg" 
              />
              {/* Glowing ring effect */}
          ...
          <div className="space-y-4">
            <div className="value-card shine fade-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="value-card shine fade-up" style={{ animationDelay: '0.4s' }}>
