  ...
  return <section className="py-20">
      <div className="container mx-auto px-4 bg-primary-foreground">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {blogPosts.slice(0, visiblePosts).map((post, index) => <article key={index} className="blog-card cursor-pointer group">
        ...
        {visiblePosts < blogPosts.length && <div className="text-center mt-10">
