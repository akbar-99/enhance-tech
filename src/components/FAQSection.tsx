  ...
  return <section className="py-20">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          <div>
            <span className="text-primary text-sm font-medium uppercase tracking-wider">WHY ENHANCE TECH ?</span>
            <h2 className="section-title mt-4">Unlock Your Full Potential</h2>
          </div>

          <div>
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="faq-item border-none">
